...
export default async function LoginPage({
  ...
  searchParams?: Promise<{ lang?: string; verification?: string }>;
}) {
  ...
  const verificationSent = resolvedSearchParams?.verification === "sent";

  return <AuthScreen initialLocale={initialLocale} mode="login" verificationSent={verificationSent} />;
}
